...
req[3]="curl http://localhost:8181/ -X POST \
  -d id=q1w2e3r4&status=pending&email=test@example.org"
req[4]="curl http://localhost:8181/q1w2e3r4 -X PUT \
  -d givenName=Mike&familyName=Mork&telephone=123-456-7890"
req[5]="curl http://localhost:8181/status/q1w2e3r4 -X PATCH \
  -d status=active"
